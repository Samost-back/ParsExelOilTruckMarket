const SECTION_RE =
  /(оливи|олива|мастил|смазк|антифриз|охолоджу|гальмівн|тосол|рідин)/i;
...
const ALL_PREFIXES = [...SPEC_KEYWORDS, ...MANUF_PREFIXES].sort(
  (a, b) => b.length - a.length,
);

const SPLIT_RE = new RegExp(
  `(?<=^|[\\s,;])(?=\\b(?:${ALL_PREFIXES.join("|")})\\b)`,
  "g",
);
...
const CAR_BRAND_KEYS_SORTED = Object.keys(CAR_BRANDS).sort(
  (a, b) => b.length - a.length,
);
